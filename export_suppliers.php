...
$rec_cnt = 0;
$sql_sel = "select count(*) as total_cnt from suppliers_info";
...
if ($rec_cnt > 0)
{
	...
	$sql_sel_rec = "select name,phone_number,email,address,user_avatar from suppliers_info";
