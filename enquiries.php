...
if (isset($_POST['SubmitDelete']) and ($_POST['SubmitDelete']=='Delete'))
{
	...
	{		
		...
		{
			// delete record 
			$sql_del = sprintf("delete from enquiries_info where auto_id=%d",$del_id);		
			$res_del = mysqli_query($con,$sql_del) or die(mysqli_error($con));	
				
			// save log					
			saveLog($del_id,'Enquiry','Enquiry','removed');		
		}
...
$sql_first = "select count(*) as totalCount from enquiries_info where is_deleted=0";
...
if (isset($_SESSION['serach_value']) and strlen($_SESSION['serach_value'])>0)
{
	...
	$sqlpart = " and ((name like ('%" . $tmp_val . "%')) or (category like ('%" . $tmp_val . "%')) or (status like ('%". $tmp_val."%'))  or (email like ('%". $tmp_val."%')) or (phone like ('%". $tmp_val."%')))";
        						  					...
        						  					<table width="100%" class="table-condensed table-striped table-hover dataTable no-footer">
        						  						<thead>
        						      						<tr>
        							                            ...
        							                            <th> 
        							                                ...
        							                                if ($date_time == 'd') {
        							                                ?>
        							                                	<a href="enquiries.php?date_time=a">Date Time&nbsp;<img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($date_time == 'a') {
        															?>
        																<a href="enquiries.php?date_time=d">Date Time&nbsp;<img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="enquiries.php?date_time=d">Date Time&nbsp;</a>
        															<?php
        															}
        															?>
        							                            </th>
        							                            ...
        							                            <th > 
        							                             ...
        							                             <th > 
        							                                ...
        							                                if ($category == 'd') {
        							                                ?>
        							                                	<a href="enquiries.php?category=a">Category&nbsp; <img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($category == 'a') {
        															?>
        																<a href="enquiries.php?category=d">Category&nbsp; <img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="enquiries.php?category=d">Category&nbsp; </a>
        															<?php
        															}
        															?>
        							                            </th>
        							                            <th > 
        							                                ...
        							                                if ($status == 'd') {
        							                                ?>
        							                                	<a href="enquiries.php?status=a">Status&nbsp; <img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($status == 'a') {
        															?>
        																<a href="enquiries.php?status=d">Status&nbsp; <img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="enquiries.php?status=d">Status&nbsp; </a>
        															<?php
        															}
        															?>
        							                            </th>
        					      						...
        					      						<?php
        								                    ...
        								                    } else 
        								                    {
        								                        ...
        								                        $sql_first_select = "select * from enquiries_info where is_deleted=0";
        								                        ...
        								                        while ($seerec = mysqli_fetch_assoc($result))
        								                        {
        						                                    ...
        						                                    <tr>
        						                                        ...
        						                                        <td ><label><a href="enquiry.php?rid=<?php echo $seerec['auto_id']; ?>"><?php 
        						                                        	$date = date('M d, Y, h:i a',strtotime($seerec['date_time']));
        						                                        	echo $date; ?></a></label></td>
        						                                        <td style="color:green"><?php echo $seerec['name']; ?></td>
        						                                        <td style="color:green"><?php echo $seerec['phone']; ?></td>
        						                                        <td style="color:green"><?php echo $seerec['email']; ?></td>
        						                                        <td style="color:green"><?php echo $seerec['category']; ?></td>
        						                                        <td style="color:green"><?php echo $seerec['status']; ?></td>
        						                                    </tr>
        														<?php        															
        														}
        														?>								                       
