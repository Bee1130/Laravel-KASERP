...
$rec_cnt = 0;
$sql_sel = "select count(*) as total_cnt from materials_info";
...
if ($rec_cnt > 0)
{
	...
	$sql_sel_rec = "select name,supplier,code,category,description,price_net,inc_vat,unit from materials_info";
