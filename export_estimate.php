...
$rec_cnt = 0;
$sql_sel = "select count(*) as total_cnt from estimates_info";
...
if ($rec_cnt > 0)
{
	...
	$sql_sel_rec = "select name,est_date,addr1,est_no,estimate_type,contact,email,mobile,post_code,contact_tel from estimates_info";
