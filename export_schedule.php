...
$rec_cnt = 0;
$sql_sel = "select count(*) as total_cnt from reminders_info";
...
if ($rec_cnt > 0)
{
	...
	$sql_sel_rec = "select start,end,title,description,all_day,public from reminders_info";
