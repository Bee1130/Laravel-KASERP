...
if (isset($_POST['SubmitDelete']) and ($_POST['SubmitDelete']=='Delete'))
{
	...
	{		
		...
		{
			// delete record 
			$sql_del = sprintf("delete from suppliers_info where auto_id=%d",$del_id);		
...
$sql_first = "select count(*) as totalCount from suppliers_info where is_deleted=0".$_SESSION['filter_user'];
...
if (isset($_SESSION['serach_value']) and strlen($_SESSION['serach_value'])>0)
{
	...
	$sqlpart = " and ((name like ('%" . $tmp_val . "%')) or (address like ('%". $tmp_val."%'))  or (email like ('%". $tmp_val."%')) or (phone_number like ('%". $tmp_val."%')) or (website like ('%". $tmp_val."%')))";
...
if ($phone_number == 'd') {
    $extra_parameters .= "&phone_number=d";
    $order = " order by phone_number desc";
}

if ($phone_number == 'a') {
    $extra_parameters .= "&phone_number=a";
    $order = " order by phone_number asc";
}
        		    ...
        		    <?php include('menu.php'); ?>
          			...
          			<div id="my-main-content">  		
                    	...
                    	<div class="my-home-content">     
                    		<form class="form-horizontal" method="post" enctype="multipart/form-data" action="suppliers.php" style="margin-bottom: 10px;">
        	                        	 		...
        	                        	 		<table style="width:100%">
        	                        	 			<tr>
														 ...
														 <?php
        													...
        													<a href="export_suppliers.php" target="_blank" style="text-decoration: none;color:white"><button type="button" class="btn btn-success btn-sm" name="Submit" id="btnExport" value="Export" style="margin-top: -4px">Export</button></a>	         
        													<a href="import_suppliers.php" target="_blank" style="text-decoration: none;color:white"><button type="button" class="btn btn-success btn-sm" name="Submit" id="btnImport" value="Import" style="margin-top: -4px">Import</button></a>		                       
        	                        	 				</td>
        	                        	 				<td align="right">		
        	                        	 					<form action="suppliers.php" method="POST" id="search_form">
        						  					...
        						  					<table width="100%" class="table-condensed table-striped table-hover dataTable no-footer">
        						  						<thead>
        						      						<tr>
        							                            ...
        							                            <th> 
        							                                ...
        							                                if ($name == 'd') {
        							                                ?>
        							                                	<a href="suppliers.php?name=a">Name&nbsp;<img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($name == 'a') {
        															?>
        																<a href="suppliers.php?name=d">Name&nbsp;<img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="suppliers.php?name=d">Name&nbsp;</a>
        															<?php
        															}
        															?>
        							                            </th>
        							                            <th > 
        							                                ...
        							                                if ($email == 'd') {
        							                                ?>
        							                                	<a href="suppliers.php?email=a">Email&nbsp; <img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($email == 'a') {
        															?>
        																<a href="suppliers.php?email=d">Email&nbsp; <img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="suppliers.php?email=d">Email&nbsp; </a>
        															<?php
        															}
        															?>
        							                            </th>
        							                            <th > 
        							                                ...
        							                                if ($phone_number == 'd') {
        							                                ?>
        							                                	<a href="suppliers.php?phone_number=a">Phone&nbsp; <img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($phone_number == 'a') {
        															?>
        																<a href="suppliers.php?phone_number=d">Phone&nbsp; <img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="suppliers.php?phone_number=d">Phone&nbsp; </a>
        															<?php
        															}
        															?>
        							                            </th>
        							                             <th > 
        							                                ...
        							                                if ($address == 'd') {
        							                                ?>
        							                                	<a href="suppliers.php?address=a">Google Address&nbsp; <img src="images/arrow_down.gif"> </a>
        							                                <?php
        															} else if ($address == 'a') {
        															?>
        																<a href="suppliers.php?address=d">Google Address&nbsp; <img src="images/arrow_up.gif"> </a>
        															<?php
        															} else {
        															?>
        																<a href="suppliers.php?address=d">Google Address&nbsp; </a>
        															<?php
        															}
        															?>
        							                            </th>
        					      						...
        					      						<?php
        								                    ...
        								                    } else 
        								                    {
        								                        ...
        								                        $sql_first_select = "select * from suppliers_info where is_deleted=0".$_SESSION['filter_user'];
        								                        ...
        								                        while ($seerec = mysqli_fetch_assoc($result))
        								                        {
        						                                    ...
        						                                    <tr>
        						                                        ...
        						                                        <td ><label><a href="supplier.php?rid=<?php echo $seerec['auto_id']; ?>"><?php echo $seerec['name']; ?></a></label></td>
        						                                        <td style="color:green"><?php echo $seerec['email']; ?></td>
        						                                        <td style="color:green"><?php echo $seerec['phone_number']; ?></td>
        					...
        					<div class="row mobile-row">							
        		  				<div class="row mobile-row">
        		  					<ul class="pager">
        		  						<?php echo pagination(1, 'suppliers.php', $noofrecords, $pagesize, $page, $extra_parameters);?>
        		  					</ul>  				
        		  				</div>
        		            </div>           			
                    	</div>	
