...
$sql = "select count(*) as totalCount from mail_junk_info where mail_type != 'deleted'";
		...
		<div class="container">
  			...
  			<div id="my-main-content">  		
            	...
            	<div class="my-home-content">     
            		<form class="form-horizontal" method="post" enctype="multipart/form-data" action="junk.php" style="margin-bottom: 10px;">
						  				...
						  				<div class="table-responsive">    
						  					<table width="100%" class="table-condensed table-striped table-hover dataTable no-footer">
					      						...
					      						<?php
								                    ...
								                    {
								                        $sql_first_select = "select * from mail_junk_info where mail_type != 'deleted'";
								                        ...
								                        {								    
						                                    ...
						                                    ?>
						                                    <tr>
						                                    	 <td style="width:30%"><label><a href="mail_detail.php?type=junk&uid=<?php echo $seerec['mail_uid']; ?>&mail_rcvr=<?php echo $seerec['mail_rcvr']; ?>"><?php echo $seerec['mail_subject']; ?></a></label></td>
					...
					<div class="row mobile-row">							
		  				<div class="row mobile-row">
		  					<ul class="pager">
		  						<?php echo pagination(1, 'junk.php', $noofrecords, $pagesize, $page, $extra_parameters);?>
		  					</ul>  				
		  				</div>
		            </div>           			
            	</div>	
