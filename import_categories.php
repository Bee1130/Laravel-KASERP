			...
			while(($filesop = fgetcsv($handle)) !== false)
			{
				...
				}else
				{
			        ...
			        /* No	Name	Desription*/     
		           	...
		           	$description = mysqli_real_escape_string($con,$filesop[2]);
		           	
			        $sql = sprintf("insert into categories_info (name,description) VALUES ('%s','%s')",$name,$description);
...
<body>
    <div class="container">
    	    ...
    	    <div class="main-content">
            	...
            	<form name="frmSearch" method="post" enctype="multipart/form-data" action="import_categories.php">
            		<div class="container">
