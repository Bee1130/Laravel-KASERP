...
class GeeVeeAPI {
	...
	private function login(){
		...
		$res = $this->curlGet($this->init_url);
		if ($res == false)
			return $res;
...
//	 fail : false
	...
	/*=============
	 succ : True,  if the CURLOPT_RETURNTRANSFER option is set, it will return the result on success.
	 fail : false
	=============*/
