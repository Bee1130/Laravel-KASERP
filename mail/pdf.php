...
function Footer()
{
    ...
    // Page number
    $this->Cell(0,1,$this->PageNo().'|Page',0,0);
	$this->SetX(150);
	$this->Cell(0,1,'Copyright 2015 - DirectFunder.com',0,0,'l');
}
...
function Output($output,$html) {
	$pdf = new PDF();
	$pdf->SetFont('times','',15);
	$pdf->AddPage();
	//$pdf->SetLink($link);
	$pdf->Image('http://directfunder.com/mail/pdflogo.png',150,8,50,15,'','');
