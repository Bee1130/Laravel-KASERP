...
<style type="text/css">
    ...
    @font-face {
      font-family: "Goldplay_menu";
      src: url("fonts/Goldplay-SemiBold.fc1fc4cec356cd5dca20.woff2") format("woff2");
    }
    
    @font-face {
      font-family: "GoldplayAlt-SemiBold";
      src: url("fonts/GoldplayAlt-SemiBold.16248d40be952a07067b.woff2") format("woff2");
    }
...
#top-menu li a {
    color: rgb(55,123,104);   
    font-size: 15px;
}

.nav>li>a:focus, .nav>li>a:hover {
    border-radius: 5px;
    background: rgb(71,158,134);
}
...
.dropdown-submenu>a:after {
	...
	.panel-inverse>.panel-heading {
	    background-color: rgb(55,123,104); 
	    color: white;
	}
	.panel-toolbar {
